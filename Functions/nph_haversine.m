...
function [km,az] = nph_haversine(loc1,loc2)
...
% Azimuth is from loc1 TO loc2:

az = atan2(cos(loc2(:,1)) .* sin(loc2(:,2)-loc1(:,2)),...
           cos(loc1(:,1)) .* sin(loc2(:,1)) - sin(loc1(:,1)) .* cos(loc2(:,1)) .* cos(loc2(:,2)-loc1(:,2)));
